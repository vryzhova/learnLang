            ...
            <TableBody>
              {words.map((word) => (
                <TableRow key={word.id}>
                  ...
                  <TableCell align="right">
                    {edit ? (
                      <input type="text" defaultValue={word.english}></input>
                    ) : (
                      word.english
                    )}
                  </TableCell>
                  <TableCell align="right">
                    {edit ? (
                      <input type="text" defaultValue={word.russian}></input>
                    ) : (
                      word.russian
                    )}
                  </TableCell>
                  <TableCell align="right">
                    <IconButton
                      aria-label="delete"
                      onClick={() => removeItem(word.id)}
                    >
                      <DeleteIcon />
                    </IconButton>
                    <IconButton
                      aria-label="edit"
                      onClick={() => editItem(word.id)}
                    >
                      <EditIcon />
                    </IconButton>
                    {edit ? (
                      <IconButton onClick={() => saveItem(word.id)}>
                        <CheckIcon />
                      </IconButton>
                    ) : (
